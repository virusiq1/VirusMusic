...
from Musicvirus.helpers.queues import QUEUE, add_to_queue, get_queue
...
from Musicvirus.helpers.merrors import capture_err
...
💻 قناة السورس : [ قناة السورس ](t.me/vrvv_v)**
""",
                )
            else:
